...
```
visualize the odds ratio using lolliplot order by the frequency of diagnosis 
```{r, echo=F}
ggplot(group2vs1[1:50,], aes(x=diagnosis, y=OR_1vs2)) + 
  geom_point(size=3) + 
  ...
  labs(title="Lollipop Chart", 
       subtitle="hisensitivity c-reactive protein: ods ratio group2 vs group1", 
       caption="order by the frequency of diagnosis") + 
  theme(axis.text.x = element_text(angle=65, vjust=0.6)) 
  #+ geom_errorbar(aes(ymax = , ymin = L))
```
