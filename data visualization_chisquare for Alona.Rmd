...
Read chi-square and diagnosis association file. This file has information of pvalue of chi-square association and oddsRatio. Hisensitivty CRP values are randomly cut into 8 categories, with category 1: 0-1mg/l being normal, and the following:  1-3,3-5,5-10,10-20,20-30,30-50,50-100, >100
```{r, eval = F}
...
## Including Plots
The odds represent 1/odds ratio, the larger the dots, the higher the risk of getting certain diagnosis compared to normal lab range (hisensitivity 0-1). In the category where the lab value is high, some cell counts go down to zero, oddsratio becomes inf, we use a different color to mark those with OR of inf. 
